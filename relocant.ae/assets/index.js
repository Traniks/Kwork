...
setInterval(() => {
  if (temp % 2 === 0) {
    promotion_vault.innerHTML = '<span data-v-8aaa8106="" class="promotion">4990</span>AED';
  } else {
    promotion_vault.innerHTML = '<span data-v-8aaa8106="" class="promotion">1400</span>USD';
  }
  temp += 1;
}, 2000);
...
const document_date = document.getElementById('date');
const date = new Date();
